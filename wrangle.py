...
REPOS = [
    ...
    "Bollo7/Life_expectancy_data_vis",
    "tomtrask/predict-it-life-expectancy",
    "Blisston/Life-Expectancy-WHO-",
    "AmonBrollo/Analyzing-Life-Expectancy",
    "JonMinton/life_expectancy_limits",
    "kianweelee/Life-Expectancy-vs-GDP",
    "BenceToth/ceu_life-expectancy",
    "ashwanijha04/Predicting-life-expectancy",
    "lucasmorin/income_life_expectancy",
    "leorrib/life-expectancy-prediction",
    "psmathur/LIfe-Expectancy-From-BMI",
    "trigger007/Life-Expectancy-Website",
    "rakeshvangawar/Life-Expectancy-Prediction-WHO",
    "mattshipmaker/SENG474Project",
    "vinayreddy115/Statistical-Data-Mining-Coursework",
    "dokipen/scotus-le",
    "Navp788/Life-Expectancy-and-GDP-Data",
    "abinjohn1/Life-Expectancy-Around-The-World",
    "xueyin97/Bias-estimating-life-expectancy-Morquio",
    "ianknowles/COVID-19.life-expectancy.dashboard",
    ...
    "niveadabre/Analysis-on-factors-influencing-life-expectancy",
    "child-trends/educational_opportunity",
    "mpascariu/MortalityGaps",
    "danlewer/oats",
    "JoeKnittel/Shiny-App",
    "timriffe/PHDS_HLE_2020",
    "DeborahStickland/LifeHourglass",
    "jamiebull1/battery-lifesaver",
    "simeonqs/Coevolution_of_relative_brain_size_and_life_expectancy_in_parrots",
    "ankitojha08/lifespan",
    "hunterthorpe/comparing_classifiers",
    "jonar12/lifeExpPrediction",
    "cran/bayesLife",
    "kpkadjei1/Data-Analysis-Project",
    "doubleminus/life-countdown",
    "MRdNk/DeathAndTaxes",
    "ashleyvarma/TooltipViz",
    "elabuel-o/choropleth-map1",
    "rifkegribenes/d3-scatterplot",
    "abhi386/Mindgap",
    "rkorzeniec/eod",
    "skyrien/lifeindays",
    "claramunro-zz/Super-Galactic-Age-Calculator",
    "nsudharsanan/epi_rural_urban_mortality_indonesia",
    "igormorzan/dynamic_gdp_graph",
    "NalinKamboj/World-Data-Statistics",
    "DorukTaneli/scheme-database",
    "dashamet/Gapminder",
    "ckraft-bot/GDHappiness",
    "johnwhittenstudio/project-5",
    "arthurtham/octopet",
]
